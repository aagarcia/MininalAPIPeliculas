...
namespace MininalAPIPeliculas.Repositorios
{
    public class RepositorioComentarios : IRepositorioComentarios
    {
        ...
        public async Task<bool> ExistePorPeliculaYId(int id, int peliculaId)
        {
            return await context.Comentarios.AnyAsync(c => c.Id == id && c.PeliculaId == peliculaId);
        }

        public async Task<bool> ExistePorPelicula(int peliculaId)
        {
            return await context.Comentarios.AnyAsync(c => c.PeliculaId == peliculaId);
        }
